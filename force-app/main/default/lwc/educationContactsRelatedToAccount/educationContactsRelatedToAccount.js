...
import getEducationRecords from '@salesforce/apex/EducationRelatedToAccountController.getEducationRecords';
...
export default class EducationContactsRelatedToAccount extends NavigationMixin(LightningElement) {
    @api recordId;
    columns = COLUMNS;
    isLoading = true;
    totalRecords = '0';
        ...
        getEducationRecords({
            ...
            if (returnedData) {
                for(var i=0; i<returnedData.length; i++)
                {
                    ...
                    if(returnedData[i].College__r.Type) {
                        returnedData[i].accType = returnedData[i].College__r.Type;
                    }
    ...
    */
    handleShowFullRelatedList() 
    {
        ...
        var url = '/alumni-view-all?recordId=' + this.recordId;
        if(this.isCommunity)
        {
