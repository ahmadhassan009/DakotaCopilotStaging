...
import getAccountName from '@salesforce/apex/EducationRelatedToUniversityController.getUniversityAlumniName';
import getRecordsCount from '@salesforce/apex/EducationRelatedToUniversityController.getRecordsCount';
import getEducationRecordsViewAll from '@salesforce/apex/EducationRelatedToUniversityController.getEducationRecordsViewAll';
...
export default class EducationRelatedToUniversityListView extends NavigationMixin(LightningElement) {
    @api recordId;
    @api isCommunity;
    offset = 0;
    limit = 50;
    ...
    setFieldSorting() {
        ...
        if(this.sortedBy === 'contactId') {
            ...
            this.tempSortBy = 'Contact__r.Account_Type__c';
            ...
            this.tempSortBy = DEGREE_DISTINCTION.fieldApiName;
        }
    }
            ...
            .then((educationRecords) => {
                if (educationRecords) {
                    ...
                    for (let i = 0; i < len; i++) {
                        ...
                        if(returnedData.Contact__r.Account_Type__c) {
                            returnedData.accountType = returnedData.Contact__r.Account_Type__c;
                        }
    ...
    setLinks() {
        if (this.isCommunity) {
            this.recordLink = "/" + this.communityName + "/s/university-alumni/" + this.recordId;
            this.accountNameLink = "/" + this.communityName + '/s/university-alumni/University_Alumni__c/Default';
        }
    } 
}