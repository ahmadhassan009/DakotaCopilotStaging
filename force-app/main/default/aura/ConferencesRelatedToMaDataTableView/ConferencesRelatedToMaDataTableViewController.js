({
    init: function(cmp, evt, helper) {
        var recordId;
        var recordName;
        var totalRelatedConferencesCount;
        var isCommunity;
        ...
        if(myPageRef!=undefined) //For Salesforce
        {
            ...
            totalRelatedConferencesCount = myPageRef.state.c__totalRelatedConferencesCount;
        ...
        else //For Community
        {
            ...
            for (i = 0; i < sURLVariables.length; i++) {
                ...
                else if (sParameterName[0] === 'totalRelatedConferencesCount') { 
                    sParameterName[1] === undefined ? '' : sParameterName[1];
                    totalRelatedConferencesCount = sParameterName[1];
                }
        ...
        cmp.set("v.totalRelatedConferencesCount", totalRelatedConferencesCount);
